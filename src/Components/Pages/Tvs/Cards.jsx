    ...
    <div>
      ...
      <div className="grid gap-8 p-3 grid-cols-1 md:grid-cols-2 dark:bg-black dark:text-white md:card-side bg-white text-black shadow-xl  mt-5">
        <div className="grid-cols-3">
          <figure className="w-11/12 mx-auto md:mt-8">
            <img className="w-56 h-full" src={tv_image} alt="imaeg" />
          </figure>
        </div>
        <div className="grid-cols-2">
          ...
          <div className="flex items-center flex-grow gap-4">
            ...
            <Link to={`/update/${type}/${_id}`}>
              <button className="btn bg-yellow-300">Update</button>
            </Link>
          </div>
        </div>
      </div>
